...
class _DispatcherEdgePanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final topOffset = MediaQuery.paddingOf(context).top + 118;
    const panelWidth = 270.0;
    ...
    return Positioned(
      ...
      child: IgnorePointer(
        ...
        child: Transform.translate(
          offset: Offset(panelWidth * (1 - clampedReveal), 0),
          child: Opacity(
